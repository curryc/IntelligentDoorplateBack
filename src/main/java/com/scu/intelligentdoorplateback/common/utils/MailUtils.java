...
public class MailUtils {
    ...
    public static String myEmailAccount = "currycake@163.com";
    ...
    public static void main(String[] args) {
        if(new MailUtils().sendMail("chenboven@qq.com", "丁真", "理塘丁真提醒", "中路封颗烟")) System.out.println("success");
    ...
    public static boolean sendMail(String receiveMailAccount, String personal, String subject, String content) {
        ...
        */
        ...
        try {
            transport.connect(myEmailAccount, "OJTWUKKZRDUBOYFW");
