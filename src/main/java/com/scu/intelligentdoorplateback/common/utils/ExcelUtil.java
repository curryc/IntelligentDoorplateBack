...
import com.scu.intelligentdoorplateback.model.vo.RecordVO;
...
public class ExcelUtil {
    ...
    public static void exportRecord(HttpServletResponse response, List<RecordVO> adminVOS) throws IOException {
        //声明一个工作簿
        ...
        // cbw：进行字段的写入
        for (short i = 0; i < adminVOS.size(); i++) {
            row = sheet.createRow(i + 2);
            cell = row.createCell(0);
            cell.setCellStyle(commStyle);
            cell.setCellValue(adminVOS.get(i).getId());

//            cell = row.createCell(1);
//            cell.setCellStyle(commStyle);
//            cell.setCellValue(adminVOS.get(i).getLoginName());
//
//            cell = row.createCell(2);
//            cell.setCellStyle(commStyle);
//            cell.setCellValue(adminVOS.get(i).getPassword());
//
//            cell = row.createCell(3);
//            cell.setCellStyle(commStyle);
//            cell.setCellValue(Objects.isNull(adminVOS.get(i).getLastLoginTime())?"":adminVOS.get(i).getLastLoginTime().toString().replace("T"," "));
//            cell = row.createCell(4);
//            cell.setCellStyle(commStyle);
//            cell.setCellValue(adminVOS.get(i).getRemark());
//            cell = row.createCell(5);
//            cell.setCellStyle(commStyle);
//            cell.setCellValue(adminVOS.get(i).getRoleName());
